...
VeilstoneCity_SetDawnPartnerTeam:
    ...
    SetVar VAR_0x8004, TRAINER_DAWN_VEILSTONE_CITY_BAGON
    GoToIfEq VAR_RESULT, SPECIES_BAGON, _099D
    SetVar VAR_0x8004, TRAINER_DAWN_VEILSTONE_CITY_DRATINI
    GoToIfEq VAR_RESULT, SPECIES_DRATINI, _099D
    SetVar VAR_0x8004, TRAINER_DAWN_VEILSTONE_CITY_GIBLE
    Return

VeilstoneCity_SetLucasPartnerTeam:
    GetPlayerStarterSpecies VAR_RESULT
    SetVar VAR_0x8004, TRAINER_LUCAS_VEILSTONE_CITY_BAGON
    GoToIfEq VAR_RESULT, SPECIES_BAGON, _099D
    SetVar VAR_0x8004, TRAINER_LUCAS_VEILSTONE_CITY_DRATINI
    GoToIfEq VAR_RESULT, SPECIES_DRATINI, _099D
    SetVar VAR_0x8004, TRAINER_LUCAS_VEILSTONE_CITY_GIBLE
    Return
