...
JubilifeCity_SetDawnPartnerTeam:
    ...
    SetVar VAR_0x8004, TRAINER_DAWN_JUBILIFE_CITY_BAGON
    GoToIfEq VAR_RESULT, SPECIES_BAGON, JubilifeCity_Return
    SetVar VAR_0x8004, TRAINER_DAWN_JUBILIFE_CITY_DRATINI
    GoToIfEq VAR_RESULT, SPECIES_DRATINI, JubilifeCity_Return
    SetVar VAR_0x8004, TRAINER_DAWN_JUBILIFE_CITY_GIBLE
    Return

JubilifeCity_SetLucasPartnerTeam:
    GetPlayerStarterSpecies VAR_RESULT
    SetVar VAR_0x8004, TRAINER_LUCAS_JUBILIFE_CITY_BAGON
    GoToIfEq VAR_RESULT, SPECIES_BAGON, JubilifeCity_Return
    SetVar VAR_0x8004, TRAINER_LUCAS_JUBILIFE_CITY_DRATINI
    GoToIfEq VAR_RESULT, SPECIES_DRATINI, JubilifeCity_Return
    SetVar VAR_0x8004, TRAINER_LUCAS_JUBILIFE_CITY_GIBLE
    Return
