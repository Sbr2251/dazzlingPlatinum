...
_009C:
    ...
    SetObjectEventMovementType PASTORIA_CITY_GRUNT_M, MOVEMENT_TYPE_LOOK_EAST
    End
...
_012F:
    ...
    CallIfEq VAR_RESULT, SPECIES_GIBLE, _0194
    CallIfEq VAR_RESULT, SPECIES_BAGON, _019C
    CallIfEq VAR_RESULT, SPECIES_DRATINI, _01A4
...
_04C8:
    ...
    WaitMovement
    GetPlayerStarterSpecies VAR_RESULT
    GoToIfEq VAR_RESULT, SPECIES_GIBLE, _054B
    GoToIfEq VAR_RESULT, SPECIES_BAGON, _0557
    GoTo _053F

_053F:
    StartTrainerBattle TRAINER_RIVAL_PASTORIA_CITY_DRATINI
    GoTo _0563

_054B:
    StartTrainerBattle TRAINER_RIVAL_PASTORIA_CITY_GIBLE
    GoTo _0563

_0557:
    StartTrainerBattle TRAINER_RIVAL_PASTORIA_CITY_BAGON
    GoTo _0563
