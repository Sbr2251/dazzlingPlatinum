...
static const u16 sTMHMMoves[] = {
    ...
    [TMHM_ID(TM93)] = MOVE_CUT,
    [TMHM_ID(TM94)] = MOVE_FLY,
    [TMHM_ID(TM95)] = MOVE_SURF,
    [TMHM_ID(TM96)] = MOVE_STRENGTH,
    [TMHM_ID(TM97)] = MOVE_DEFOG,
    [TMHM_ID(TM98)] = MOVE_ROCK_SMASH,
    [TMHM_ID(TM99)] = MOVE_WATERFALL,
    [TMHM_ID(TM100)] = MOVE_ROCK_CLIMB,
};
