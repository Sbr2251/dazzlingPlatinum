...
void ov99_021D439C(UnkStruct_ov99_021D2CB0 *param0, int param1, int param2, int param3)
{
    ...
    // the slideshow tiles are LZ-compressed in ending.narc by tools/scripts/shrink_demo_narcs.py
    Graphics_LoadTilesToBgLayerFromOpenNARC(param0->unk_10F8, v3->unk_00, param0->unk_08, param2, 0, 0, TRUE, HEAP_ID_75);
